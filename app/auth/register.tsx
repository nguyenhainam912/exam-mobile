      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={{ flex: 1, justifyContent: 'flex-end', paddingHorizontal: 0 }}>
          <View style={{ alignItems: 'center', marginBottom: 16 }}>
            <Text variant="displaySmall" style={{ color: '#8B5CF6', fontWeight: 'bold' }}>Đăng ký</Text>
          ...
          >
            ...
            <Button mode="contained" onPress={onSubmit} disabled={loading} style={{ marginBottom: 16 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginBottom: 8 }}>
              ...
              <Link href="/auth/login">
                <Text style={{ color: '#3b82f6', fontWeight: '600' }}>Đăng nhập ngay</Text>
              </Link>
            </View>
          </View>
        </View>
