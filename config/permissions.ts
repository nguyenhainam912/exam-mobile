export const ALL_PERMISSIONS = {
  ...
  PERMISSIONS: {
    ...
    DELETE: {
      method: 'DELETE',
      apiPath: '/rbac/permission/:id',
      module: 'RBAC',
    },
    GET_PAGINATE: {
      method: 'GET',
      apiPath: '/rbac/permissions/pageable',
      module: 'RBAC',
    },
    GET_BY_ID: {
      method: 'GET',
      apiPath: '/rbac/permissions/:id',
      module: 'RBAC',
    },
    CHECK_USER_PERMISSION: {
      method: 'POST',
      apiPath: '/rbac/check-permission',
      module: 'RBAC',
    },
    ASSIGN_ROLE: {
      method: 'POST',
      apiPath: '/rbac/assign-role',
      module: 'RBAC',
    },
  },
  ...
  EXAMS: {
    ...
    GENERATE_PDF: {
      method: 'POST',
      apiPath: '/exams/:id/generate-pdf',
      module: 'EXAMS',
    },
    UPLOAD_FILE: {
      method: 'POST',
      apiPath: '/exams/upload-file',
      module: 'EXAMS',
    },
  },
